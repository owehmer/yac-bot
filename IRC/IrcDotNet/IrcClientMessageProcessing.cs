...
namespace IrcDotNet
{
    ...
    partial class IrcClient
    {
        ...
        protected internal void ProcessMessageNick(IrcMessage message)
        {
            ...
            if (sourceUser == null)
                throw new ProtocolViolationException(string.Format(
                    IRC.Properties.Resources.MessageSourceNotUser, message.Source.Name));
        ...
        protected internal void ProcessMessageMode(IrcMessage message)
        {
            ...
            {
                throw new ProtocolViolationException(string.Format(IRC.Properties.Resources.MessageCannotSetUserMode,
