    ...
    public abstract partial class IrcClient : IDisposable
    {
        ...
        protected bool HandleISupportParameter(string paramName, string paramValue)
        {
            ...
            if (paramName.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "paramName");
            ...
            switch (paramName.ToLowerInvariant())
            {
                case "prefix":
                    ...
                    if (prefixes.Length != modes.Length)
                        throw new ProtocolViolationException(IRC.Properties.Resources.MessageISupportPrefixInvalid);
        ...
        protected Tuple<string, string> GetUserModeAndNickName(string input)
        {
            ...
            if (input.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "input");
            ...
            switch (type)
            {
                ...
                default:
                    throw new ArgumentException(string.Format(
                        IRC.Properties.Resources.MessageInvalidChannelType, type), "type");
            }
        }
        ...
        protected IIrcMessageTarget GetMessageTarget(string targetName)
        {
            ...
            if (targetName.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "targetName");
            ...
            {
                // Find user by nick name. If no user exists in list, create it and set its IRC.Properties.
            ...
            {
                // Find user by user  name. If no user exists in list, create it and set its IRC.Properties.
                var user = GetUserFromNickName(nickName, true);
                if (user.HostName == null)
                    user.HostName = hostName;
            ...
            {
                throw new ArgumentException(string.Format(
                    IRC.Properties.Resources.MessageInvalidSource, targetName), "targetName");
            }
        }
        ...
        protected IIrcMessageSource GetSourceFromPrefix(string prefix)
        {
            if (prefix == null)
                return null;
            if (prefix.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "prefix");
            ...
            {
                throw new ArgumentException(string.Format(
                    IRC.Properties.Resources.MessageInvalidSource, prefix), "prefix");
            }
        }
        ...
        protected IrcServer GetServerFromHostName(string hostName, out bool createdNew)
        {
            ...
            if (hostName.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "hostName");
        ...
        protected IrcChannel GetChannelFromName(string channelName, out bool createdNew)
        {
            ...
            if (channelName.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "channelName");
        ...
        protected IrcUser GetUserFromNickName(string nickName, bool isOnline, out bool createdNew)
        {
            ...
            if (nickName.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "nickName");
        ...
        protected IrcUser GetUserFromUserName(string userName, out bool createdNew)
        {
            ...
            if (userName.Length == 0)
                throw new ArgumentException(IRC.Properties.Resources.MessageValueCannotBeEmptyString, "userName");
            ...
            foreach (var method in this.GetAttributedMethods<MessageProcessorAttribute, MessageProcessor>())
            {
                ...
                else
                {
                    throw new ProtocolViolationException(string.Format(
                        IRC.Properties.Resources.MessageInvalidCommandDefinition, attribute.CommandName));
                }
            };
        }
        ...
        protected void WriteMessage(IrcMessage message)
        {
            ...
            if (message.Command == null)
                throw new ArgumentException(IRC.Properties.Resources.MessageInvalidCommand, "message");
            if (message.Parameters.Count > maxParamsCount)
                throw new ArgumentException(IRC.Properties.Resources.MessageTooManyParams, "parameters");
        ...
        private string CheckPrefix(string value)
        {
            ...
            {
                throw new ArgumentException(string.Format(
                    IRC.Properties.Resources.MessageInvalidPrefix, value), "value");
            }
        ...
        private string CheckCommand(string value)
        {
            ...
            {
                throw new ArgumentException(string.Format(
                    IRC.Properties.Resources.MessageInvalidCommand, value), "value");
            }
        ...
        private string CheckMiddleParameter(string value)
        {
            ...
            {
                throw new ArgumentException(string.Format(
                    IRC.Properties.Resources.MessageInvalidMiddleParameter, value), "value");
            }
        ...
        protected void CheckRegistrationInfo(IrcRegistrationInfo registrationInfo, string registrationInfoParamName)
        {
            ...
            if (registrationInfo is IrcUserRegistrationInfo)
            {
                if (registrationInfo.NickName == null ||
                    ...
                    throw new ArgumentException(IRC.Properties.Resources.MessageInvalidUserRegistrationInfo,
            ...
            else if (registrationInfo is IrcServiceRegistrationInfo)
            {
                if (registrationInfo.NickName == null ||
                    ...
                    throw new ArgumentException(IRC.Properties.Resources.MessageInvalidServiceRegistrationInfo,
                        registrationInfoParamName);
            }
            else
            {
                throw new ArgumentException(IRC.Properties.Resources.MessageInvalidRegistrationInfoObject,
                    registrationInfoParamName);
            }
        }
