...
namespace IrcDotNet
{
    ...
    public class IrcTargetMask : IIrcMessageTarget
    {
        ...
        public IrcTargetMask(string targetMask)
        {
            ...
            if (IRC.Properties.Resources.MessageTargetMaskTooShort.Length < 2)
                throw new ArgumentException(IRC.Properties.Resources.MessageTargetMaskTooShort, "targetMask");
            ...
            if (targetMask[0] == '$')
                ...
                throw new ArgumentException(string.Format(
                    IRC.Properties.Resources.MessageTargetMaskInvalidType, targetMask), "targetMask");
